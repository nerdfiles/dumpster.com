...
var PageName = 'Payment Info Guest';
var PageId = '4113ea2db36b4161b9c9216fa716ddf2'
var PageUrl = 'Payment_Info_Guest.html'
document.title = 'Payment Info Guest';
var PageNotes = 
{
"pageName":"Payment Info Guest",
"showNotesNames":"False",
"Page Descriptions":"<p style=\"text-align:left;\"><span style=\"\">This page is displayed after the user has completed the Delivery Info page.<\/span><\/p>",
...
if (bIE) u57.attachEvent("onkeyup", KeyUpu57);
else u57.addEventListener("keyup", KeyUpu57, true);
function KeyUpu57(e)
{
windowEvent = e;
...
if (true) {
	...
	SetPanelState('u58', 'pd1u58','fade','','100','fade','','100');
...
"Description":"Disable after submit"};
...
InsertBeforeEnd(u33LinksClick, "<div class='intcaselink' onmouseout='SuppressBubble(event)' onclick='u33Clicku70f42676165142a5b87a7467cb95e656(event)'>Valid Payment</div>");
function u33Clicku70f42676165142a5b87a7467cb95e656(e)
{
...
InsertBeforeEnd(u33LinksClick, "<div class='intcaselink' onmouseout='SuppressBubble(event)' onclick='u33Clickud1851ccfe8e04587a897aece8b3ecaed(event)'>Payment Declined</div>");
function u33Clickud1851ccfe8e04587a897aece8b3ecaed(e)
{

	self.location.href="Payment_Declined.html" + GetQuerystring();
