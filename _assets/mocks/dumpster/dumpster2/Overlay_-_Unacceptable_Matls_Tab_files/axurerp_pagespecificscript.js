...
var PageName = 'Overlay - Unacceptable Matls Tab';
var PageId = '95fc8c355d1d40729480916f1b6ddc94'
var PageUrl = 'Overlay_-_Unacceptable_Matls_Tab.html'
document.title = 'Overlay - Unacceptable Matls Tab';
var PageNotes = 
{
"pageName":"Overlay - Unacceptable Matls Tab",
...
x = 0;
y = 0;
InsertAfterBegin(document.getElementById('u259ann'), "<div id='u259Note' class='annnoteimage' style='left:" + x + ";top:" + y + "'></div>");
$('#u259Note').click(function(e) { ToggleWorkflow(e, 'u259', 300, 150, false); return false; });
var u259Ann = 
{
...
x = 0;
y = 0;
InsertAfterBegin(document.getElementById('u266ann'), "<div id='u266Note' class='annnoteimage' style='left:" + x + ";top:" + y + "'></div>");
$('#u266Note').click(function(e) { ToggleWorkflow(e, 'u266', 300, 150, false); return false; });
var u266Ann = 
{
