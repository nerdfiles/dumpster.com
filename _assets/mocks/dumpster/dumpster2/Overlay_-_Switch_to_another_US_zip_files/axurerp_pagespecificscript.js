...
var PageName = 'Overlay - Switch to another US zip';
var PageId = '6b66b3ba4bf442318b6fce79b1b7da9d'
var PageUrl = 'Overlay_-_Switch_to_another_US_zip.html'
document.title = 'Overlay - Switch to another US zip';
var PageNotes = 
{
"pageName":"Overlay - Switch to another US zip",
...
x = 0;
y = 0;
InsertAfterBegin(document.getElementById('u230ann'), "<div id='u230Note' class='annnoteimage' style='left:" + x + ";top:" + y + "'></div>");
$('#u230Note').click(function(e) { ToggleWorkflow(e, 'u230', 300, 150, false); return false; });
var u230Ann = 
{
"label":"Select Dumpster Button",
"Description":"This button opens the 'Residential Dumpster Selection 2' page."};
...
var u255Ann = 
{
"label":"Continue to US Zip Code Button",
...
{
"label":"Cancel Button",
"Description":"Cancels new zip code entry and closes the overlay box."};
