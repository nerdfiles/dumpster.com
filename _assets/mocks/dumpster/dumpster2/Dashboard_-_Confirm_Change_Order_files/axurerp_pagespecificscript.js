...
var PageName = 'Dashboard - Confirm Change Order';
var PageId = 'a35de48c1d99462b8550e3e338f0e87b'
var PageUrl = 'Dashboard_-_Confirm_Change_Order.html'
document.title = 'Dashboard - Confirm Change Order';
var PageNotes = 
{
"pageName":"Dashboard - Confirm Change Order",
"showNotesNames":"False",
"Page Descriptions":"<p style=\"text-align:left;\"><span style=\"\">Confirmation modal box for modifying a Dumpster order from the My Account page.<\/span><\/p>",
...
var u75Ann = 
{
"label":"Confirm Order Change Button",
"Description":"Closes widget and saves modification of order. User taken to Order Confirmation page."};
...
if (true) {
	...
	self.location.href="Confirmation.html" + GetQuerystring();
...
{
"label":"Cancel Button",
"Description":"Closes widget and cancels modification of order."};
...
x = 0;
y = 0;
InsertAfterBegin(document.getElementById('u79ann'), "<div id='u79Note' class='annnoteimage' style='left:" + x + ";top:" + y + "'></div>");
$('#u79Note').click(function(e) { ToggleWorkflow(e, 'u79', 300, 150, false); return false; });
var u79Ann = 
{
