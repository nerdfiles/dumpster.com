...
var PageName = 'Payment Info';
var PageId = 'f814c25690674637acd59b824fc578fd'
var PageUrl = 'Payment_Info.html'
...
InsertBeforeEnd(u8LinksClick, "<div class='intcaselink' onmouseout='SuppressBubble(event)' onclick='u8Clicku7641387f67d441dca71eb07fe51c7dda(event)'>Valid Payment</div>");
function u8Clicku7641387f67d441dca71eb07fe51c7dda(e)
{
...
InsertBeforeEnd(u8LinksClick, "<div class='intcaselink' onmouseout='SuppressBubble(event)' onclick='u8Clicku471c8ea5217e46d49d0cff9bcf314443(event)'>Payment Declined</div>");
function u8Clicku471c8ea5217e46d49d0cff9bcf314443(e)
{
...
if (bIE) u14.attachEvent("onkeyup", KeyUpu14);
else u14.addEventListener("keyup", KeyUpu14, true);
function KeyUpu14(e)
{
windowEvent = e;
...
if (true) {
	...
	SetPanelState('u17', 'pd1u17','fade','','100','fade','','100');
