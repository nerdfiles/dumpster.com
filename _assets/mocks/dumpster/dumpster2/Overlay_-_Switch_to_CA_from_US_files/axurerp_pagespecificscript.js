...
var PageName = 'Overlay - Switch to CA from US';
var PageId = '146f22a307e64842998b7e3bed2cc216'
var PageUrl = 'Overlay_-_Switch_to_CA_from_US.html'
document.title = 'Overlay - Switch to CA from US';
var PageNotes = 
{
"pageName":"Overlay - Switch to CA from US",
...
"UC Reference":"<p style=\"text-align:left;\"><span style=\"\">Shopping Experience-001 Zip Code Selection&nbsp; &nbsp;&nbsp; <\/span><\/p><p style=\"text-align:left;\"><span style=\"\">&nbsp;<\/span><\/p>"}
var $OnLoadVariable = '';
...
x = 0;
y = 0;
InsertAfterBegin(document.getElementById('u258ann'), "<div id='u258Note' class='annnoteimage' style='left:" + x + ";top:" + y + "'></div>");
$('#u258Note').click(function(e) { ToggleWorkflow(e, 'u258', 300, 150, false); return false; });
var u258Ann = 
{
...
var u254Ann = 
{
"label":"Continue to Canadian Site Button",
"Description":"Clicking takes user to new Dumpster page with products available for entered zip code."};
...
if (true) {
	...
	self.location.href="CA_Dumpster_Selection.html" + GetQuerystring();
...
{
"label":"Cancel Button",
"Description":"Cancels new zip code entry and closes overlay box."};
...
x = 0;
y = 0;
InsertAfterBegin(document.getElementById('u247ann'), "<div id='u247Note' class='annnoteimage' style='left:" + x + ";top:" + y + "'></div>");
$('#u247Note').click(function(e) { ToggleWorkflow(e, 'u247', 300, 150, false); return false; });
var u247Ann = 
{
"label":"Canadian Modal Dialog Box",
"Description":"This dialog box and all other Canadian dialog boxes should be displayed in its respective language. I.e. - if the user is reading the site in French, all dialog boxes should be displayed in French."};
