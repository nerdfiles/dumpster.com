...
var PageName = 'Overlay - Unacceptable Materials';
var PageId = '512b843004bf40cf81f62962f38228d8'
var PageUrl = 'Overlay_-_Unacceptable_Materials.html'
document.title = 'Overlay - Unacceptable Materials';
var PageNotes = 
{
"pageName":"Overlay - Unacceptable Materials",
"showNotesNames":"False",
"Page Descriptions":"<p style=\"text-align:left;\"><span style=\"\">This overlay is displayed when &quot;Select and Proceed to Checkout&quot; is clicked on the dumpster selection page.<\/span><\/p>",
...
x = 0;
y = 0;
InsertAfterBegin(document.getElementById('u281ann'), "<div id='u281Note' class='annnoteimage' style='left:" + x + ";top:" + y + "'></div>");
$('#u281Note').click(function(e) { ToggleWorkflow(e, 'u281', 300, 150, false); return false; });
var u281Ann = 
{
"label":"Agree button",
"Description":"Takes user to shopping cart, or in the case of certain areas such as Chicago, to the next overlay modal box."};

u281.style.cursor = 'pointer';
if (bIE) u281.attachEvent("onclick", u281Click);
else u281.addEventListener("click", u281Click, true);
InsertAfterBegin(document.body, "<DIV class='intcases' id='u281LinksClick'></DIV>")
var u281LinksClick = document.getElementById('u281LinksClick');
function u281Click(e) 
{
windowEvent = e;


	ToggleLinks(e, 'u281LinksClick');
}

InsertBeforeEnd(u281LinksClick, "<div class='intcaselink' onmouseout='SuppressBubble(event)' onclick='u281Clicku1c7014bbabbb4e39bdfc061f663f8ce6(event)'>Cart - Single Item</div>");
function u281Clicku1c7014bbabbb4e39bdfc061f663f8ce6(e)
{
...
InsertBeforeEnd(u281LinksClick, "<div class='intcaselink' onmouseout='SuppressBubble(event)' onclick='u281Clickuc947f42c6bec463ba682dcd8c42d3d0a(event)'>Cart - Multiple Items</div>");
function u281Clickuc947f42c6bec463ba682dcd8c42d3d0a(e)
{

	self.location.href="Residential_Cart_Multi_Items.html" + GetQuerystring();

	ToggleLinks(e, 'u281LinksClick');
}

InsertBeforeEnd(u281LinksClick, "<div class='intcaselink' onmouseout='SuppressBubble(event)' onclick='u281Clickud3e65c7bc43b45989422618bd3a01c23(event)'>City of Chicago Overlay</div>");
function u281Clickud3e65c7bc43b45989422618bd3a01c23(e)
{

	self.location.href="Overlay_-_City_of_Chicago.html" + GetQuerystring();
...
"Description":"Closes agreement overlay, and returns user to underlying page."};
